...
// Names come from Intl (see localization/index.js) so the map legend, the
// billing forms and the country tables all read in the panel's language
// instead of an English lookup table.
export { countryName } from "../localization";
