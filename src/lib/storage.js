...
const setHotSwapToken = (token) => { localStorage.setItem('hotSwapToken', token); };
const deleteHotSwapToken = () => { localStorage.removeItem('hotSwapToken'); };
...
export {
  ...
  setHotSwapToken, deleteHotSwapToken, getHotSwapToken,
  setLang, getLang,
};
