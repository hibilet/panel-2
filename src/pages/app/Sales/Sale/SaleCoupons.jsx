  ...
  return (
    <div className="relative">
      <div className="space-y-4">
        ...
        {isNew ? (
          <EmptyState
            ...
            description="Create and save the sale to add coupons."
          />
        ) : coupons.length === 0 ? (
          <EmptyState
            icon="fa-tag"
            title="No coupons yet"
            description="Add discount codes for your sale."
            action={
              <button
                type="button"
                onClick={() => setPanelCoupon('new')}
      ...
      <SlidePanel
        isOpen={panelOpen}
        onClose={closePanel}
        aria-label={isAdding ? 'Add coupon' : 'Edit coupon'}
      >
        <CouponPanel
    ...
    <div className="flex h-full flex-col">
      <header className="flex shrink-0 items-center justify-between gap-4 border-b border-slate-200 px-6 py-4">
        <h3 className="text-lg font-semibold text-slate-900">
          {isNew ? 'New coupon' : coupon?.code || 'Edit coupon'}
        </h3>
        <button
          type="button"
          onClick={onClose}
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-4">
              ...
              <Input
                label="Discount"
                name="discount"
                placeholder="0.2 for 20% or 200 for fixed amount"
                value={form.discount}
            ...
            <div className="space-y-4">
              ...
              <Select
                ...
                options={[
                  { value: 'active', label: 'Active — visible and usable' },
          ...
          <div className="flex flex-wrap gap-3">
            ...
            {isNew ? (
              ...
              <button
                ...
                title={hasUsed ? 'Cannot delete: coupon has been used' : 'Delete'}
              >
                {deleting ? (
                  <i className="fa-solid fa-spinner fa-spin" aria-hidden />
                ) : (
